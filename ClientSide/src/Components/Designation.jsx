...
function Designation() {
    ...
    function sortDesig(){
      fetch("http://localhost:1010/sortDesignation")
      .then((res) => res.json()) // will extract data in json format
      .then((d) => {
        // console.log(d)
        if(d){
  ...
  return (
    ...
    <div className="content">
        ...
        <div className="card border-dark mb-3 mt-5" id="categCard" >
            <div className="card-header text-center" ><h2>Designation List</h2></div>
            <div className="card-body text-dark">
                <h2 className="card-title text-center">
                  <a href='/addDesignation' className='btn btn-primary text-center mb-3' id="addCategButton">Add Designation</a>
                  <button onClick={sortDesig} className='btn btn-primary text-center mb-3 mx-1' id="addCategButton">Sort By Name <i className="bi bi-caret-down mx-1"></i> </button>
