...
// WE ARE NOT MAKING USE OF EMPLOYEE TABLE INSTEAD WE ARE USING CUSTOMER TABLE
// so this compinent is of no use in this project 
...
function AddEmployee() {
    ...
    function saveData(event){
        ...
        formData.append('password', Cust.password)
        formData.append('address', Cust.address)
        formData.append('salary',Cust.salary)
        formData.append('category',Cust.category)
        formData.append('designation',Cust.designation)
        formData.append('image',Cust.image)

        // fetch("http://localhost:1010/AddEmployee", {
        //   method: "post",
        ...
        axios.post("http://localhost:1010/AddEmployee", formData)
